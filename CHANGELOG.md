...
## [[v3.5.0](https://github.com/terraform-aws-modules/terraform-aws-alb/compare/v3.4.0...v3.5.0)] - 2018-09-03]

### Changed

- `kitchen-terraform` tests now run through Docker.
- native AWS inspec resources now used in testing.
- bump `kitchen-terraform` to version 4.0.0.
